...
urlpatterns = [
    ...
    path('<int:course_id>/teacher-results/<int:assessment_id>', views.teacher_results, name="teacher-results"),


    path('<int:course_id>/completed-assessments/<int:assessment_id>/assess-results', views.assess_results, name="assess-results"),
